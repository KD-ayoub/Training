      ...
      <div className={`h-full w-[90%] rounded-[30px] ${theme?.mode.areaBackground} border-2 border-[#FFFFFF] relative`}>
        <div className="w-[54rem] absolute top-[15%] left-[5%]">
          ...
          <div className="flex gap-10">
            <button className={`w-[14rem] h-16 p-0 text-[26px] rounded-[30px] font-Montserat ${theme?.mode.text} bg-button border border-[#FFFFFF] shadow-md shadow-[#1E1E1E]/50`}>Studio</button>
